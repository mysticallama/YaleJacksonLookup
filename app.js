  ...
  return `
      <div class="profile-card">
        ...
        <div class="profile-actions">
          ${s.noJacksonBio ? "" : `<a class="bio-link" href="https://jackson.yale.edu/person/${esc(s.slug)}/" target="_blank" rel="noopener">Full Jackson Bio ↗</a>`}
          ${s.email ? `<a class="bio-link contact" href="mailto:${esc(s.email)}">✉ Email</a>` : ""}
